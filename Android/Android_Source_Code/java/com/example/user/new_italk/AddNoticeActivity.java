...
public class AddNoticeActivity extends AppCompatActivity {
    ...
    LinearLayout addNotificationTargetButton, addedImageLinearLayout, addImageLinearLayout;
    ...
    ScrollView addNoticeScrollView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNoticeScrollView = (ScrollView)findViewById(R.id.addNoticeScrollView);
        addImageLinearLayout = (LinearLayout)findViewById(R.id.addImageLinearLayout);
        ...
        addImageLinearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        addedImageListView.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                addNoticeScrollView.requestDisallowInterceptTouchEvent(true);
                return false;
            }
        });
        addedImageListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AddNoticeActivity.this);
                dialog = builder.setMessage("해당 사진을 삭제하시겠습니까?")
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                addedImageList.remove(position);
            ...
            enrollmentButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(noticeTitle.equals("")) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(AddNoticeActivity.this);
                        dialog = builder.setMessage("공지사항 제목은 공백일 수 없습니다.")
